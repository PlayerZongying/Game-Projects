...
Shader "Custom/SH_Thomas"
{
    Properties 
    {
        ...
        _ThomasParam("ThomasParam", Float) = 0.09
    ...
    SubShader 
    {
        ...
        Pass 
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float dx = -1.0 * _ThomasParam * x + sin(y);
                float dy = -1.0 * _ThomasParam * y + sin(z);
                float dz = -1.0 * _ThomasParam * z + sin(x);
